...
public class ExtratoApiController implements ExtratoApi {
    ...
    public ResponseEntity<Extrato> consultaExtrato(@ApiParam(value = "",required=true) @PathVariable("agencia") Integer agencia,@ApiParam(value = "",required=true) @PathVariable("numero") Long numero,@ApiParam(value = "",required=true) @PathVariable("digito") Integer digito,@ApiParam(value = "" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization) {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Extrato>(objectMapper.readValue("{  \"transacoes\" : [ {    \"cliente\" : {      \"senha\" : \"senha123\",      \"cpf\" : \"11122233344\",      \"conta\" : [ null, null ],      \"id\" : 123456789,      \"titular\" : \"Lucas de Paula\"    },    \"numero\" : 12234,    \"saldo\" : 204.45,    \"agencia\" : 1234,    \"digito\" : 6  }, {    \"cliente\" : {      \"senha\" : \"senha123\",      \"cpf\" : \"11122233344\",      \"conta\" : [ null, null ],      \"id\" : 123456789,      \"titular\" : \"Lucas de Paula\"    },    \"numero\" : 12234,    \"saldo\" : 204.45,    \"agencia\" : 1234,    \"digito\" : 6  } ]}", Extrato.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
