...
public class ClienteApiController implements ClienteApi {
    ...
    public ResponseEntity<Conta> cadastrarCliente(@ApiParam(value = ""  )  @Valid @RequestBody Cliente cliente_) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Conta>(objectMapper.readValue("{  \"cliente\" : {    \"senha\" : \"senha123\",    \"cpf\" : \"11122233344\",    \"conta\" : [ null, null ],    \"id\" : 123456789,    \"titular\" : \"Lucas de Paula\"  },  \"numero\" : 12234,  \"saldo\" : 204.45,  \"agencia\" : 1234,  \"digito\" : 6}", Conta.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
