...
public class TransacaoApiController implements TransacaoApi {
    ...
    public ResponseEntity<Void> excluiValorTransacao(@ApiParam(value = "",required=true) @PathVariable("id_transacao") Long idTransacao,@ApiParam(value = "" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Void>(HttpStatus.NOT_IMPLEMENTED);
    }
